<template>
  ...
  <div class="bg-zinc-200 p-12 gap-4 flex flex-wrap">
    <div
      class="flex items-center gap-2 ring-orange-500 ring-2 hover:shadow-lg transition-all w-fit p-2 px-4 bg-orange-200"
    >
      <svg
      ...
      >
        <path
          d="M208,112a32.06,32.06,0,0,0-31,24H152a40.19,40.19,0,0,1-32-16L93.69,84.92A32,32,0,1,0,72,87v82a32,32,0,1,0,16,0V104l19.2,25.6A56.26,56.26,0,0,0,152,152h25a32,32,0,1,0,31-40ZM64,56A16,16,0,1,1,80,72,16,16,0,0,1,64,56ZM96,200a16,16,0,1,1-16-16A16,16,0,0,1,96,200Zm112-40a16,16,0,1,1,16-16A16,16,0,0,1,208,160Z"
        ></path>
      </svg>
      <p class="text-xl flex">Git</p>
    </div>
    <div
      class="flex items-center gap-2 ring-zinc-500 ring-2 hover:shadow-lg transition-all w-fit p-2 bg-zinc-200 px-4"
    >
      <i class="fa-brands fa-apple scale-150"></i>
      <p class="text-xl flex">macOS</p>
    </div>
    <div
      class="flex items-center gap-2 ring-blue-500 ring-2 hover:shadow-lg transition-all w-fit p-2 bg-blue-200 px-4"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="32"
      ...
      <p class="text-xl flex">Windows 11 + WSL2</p>
    </div>
    <div
      class="flex items-center gap-2 ring-purple-500 ring-2 hover:shadow-lg transition-all w-fit p-2 bg-purple-200 px-4"
    >
      <svg
      ...
      <p class="text-xl flex">Affinity Photo</p>
    </div>
    <div
      class="flex items-center gap-2 ring-blue-500 ring-2 hover:shadow-lg transition-all w-fit p-2 bg-blue-200 px-4"
    >
      ...
      <p class="text-xl flex">Affinity Designer</p>
    </div>
    <div
      class="flex items-center gap-2 ring-orange-500 ring-2 hover:shadow-lg transition-all w-fit p-2 bg-orange-200 px-4"
    >
      <svg
        class="aspect-square h-6"
        role="img"
    ...
    >
      ...
      <p class="text-xl flex">Blender</p>
    </div>
    <div
      class="flex items-center gap-2 ring-pink-500 ring-2 hover:shadow-lg transition-all w-fit p-2 bg-pink-200 px-4"
    >
      <svg
        class="aspect-square h-6"
        role="img"
    ...
    >
      ...
      <p class="text-xl flex">Firefox</p>
    </div>
    <div
      class="flex items-center gap-2 ring-blue-500 ring-2 hover:shadow-lg transition-all w-fit p-2 bg-blue-200 px-4"
    >
      ...
      <p class="text-xl flex">VS Code</p>
    </div>
  </div>
</template>
