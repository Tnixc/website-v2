<template>
  ...
  <div class="flex flex-wrap gap-4 bg-zinc-200 p-12">
    <div
      class="flex w-fit items-center gap-2 bg-orange-200 p-2 px-4 ring-2 ring-orange-500 transition-all hover:shadow-lg"
    >
      <svg
      ...
      <p class="flex text-xl">Git</p>
    </div>
    <div
      class="flex w-fit items-center gap-2 bg-zinc-200 p-2 px-4 ring-2 ring-zinc-500 transition-all hover:shadow-lg"
    >
      <i class="fa-brands fa-apple scale-150"></i>
      <p class="flex text-xl">macOS</p>
    </div>
    <div
      class="flex w-fit items-center gap-2 bg-blue-200 p-2 px-4 ring-2 ring-blue-500 transition-all hover:shadow-lg"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="32"
      ...
      <p class="flex text-xl">Windows 11 + WSL2</p>
    </div>
    <div
      class="flex w-fit items-center gap-2 bg-purple-200 p-2 px-4 ring-2 ring-purple-500 transition-all hover:shadow-lg"
    >
      <svg
      ...
      <p class="flex text-xl">Affinity Photo</p>
    </div>
    <div
      class="flex w-fit items-center gap-2 bg-blue-200 p-2 px-4 ring-2 ring-blue-500 transition-all hover:shadow-lg"
    >
      ...
      <p class="flex text-xl">Affinity Designer</p>
    </div>
    <div
      class="flex w-fit items-center gap-2 bg-orange-200 p-2 px-4 ring-2 ring-orange-500 transition-all hover:shadow-lg"
    >
    ...
    >
      ...
      <p class="flex text-xl">Blender</p>
    </div>
    <div
      class="flex w-fit items-center gap-2 bg-pink-200 p-2 px-4 ring-2 ring-pink-500 transition-all hover:shadow-lg"
    >
      <svg
        class="aspect-square h-6"
        role="img"
    ...
    >
      ...
      <p class="flex text-xl">Firefox</p>
    </div>
    <div
      class="flex w-fit items-center gap-2 bg-blue-200 p-2 px-4 ring-2 ring-blue-500 transition-all hover:shadow-lg"
    >
      ...
      <p class="flex text-xl">VS Code</p>
    </div>
  </div>
</template>
