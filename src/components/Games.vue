<template>
  ...
  <div class="border-l-2 ml-48 p-12 bg-violet-100/40 w-8/12 backdrop-blur-lg border-violet-300 border-b-zinc-50 border-b-2">
    <div class="flex gap-2 flex-wrap">
      ...
      <p class="p-4 ring-2 ring-violet-300 bg-violet-50">Genshin Impact (Not really 🙏)</p>
