<template>
  <h1
    class="ml-24 mt-24 text-5xl bg-blue-200 w-7/12 border-l-2 border-t-2 border-blue-500 shadow-xl transition-all hover:border-l-8"
  >
    ## Contact + Links
  </h1>
  <div
    id="container" class="ml-24 p-12 bg-blue-100/40 w-7/12 border-l-2 border-blue-300 backdrop-blur-lg"
  >
    <div class="flex gap-2">
      <div class="p-2 bg-blue-50 flex items-center">
        <i class="p-2 scale-125 fa-brands fa-discord"></i>
        <p class="p-2 font-xl">Tnixc</p>
      </div>
      <a class="li p-2 bg-blue-50 flex items-center" href="https://twitter.com/_Tnixc" target="_blank">
      ...
      <a
        class="li p-2 bg-blue-50 flex items-center"
